# Generated by Django 4.2.19 on 2025-02-11 04:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text="Enter the book's natural language (e.g. English, French, Yapanese, etc.)", max_length=200, unique=True)),
            ],
        ),
