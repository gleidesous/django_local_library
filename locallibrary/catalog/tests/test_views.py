...
class LoanedBookInstancesByUserListViewTest(TestCase):
  ...
  def test_only_borrowed_books_in_list(self):
    ...
    # Check that initially we don't have any books in list (none one loan)
...
class RenewBookInstancesViewTest(TestCase):
  ...
  def test_redirect_if_not_logged_in(self):
    ...
    # Manually check redirect (Can't use assertRedirect because the redirect URL is unpredicatble)
  ...
  def test_redirects_to_all_borrowed_book_list_on_success(self):
    ...
    self.assertRedirects(response, reverse('all-loans'))
